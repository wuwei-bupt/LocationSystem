...
$().ready(function() {
	...
	$('#lcbm').combobox('select', '${inforeport.lcbm}');
...
<body class="easyui-layout">
	<div data-options="region:'center',border:false" title="防治工艺上报 > 编辑" style="">
		<div class="container" >
			<br>&nbsp;&nbsp;&nbsp;&raquo;防治工艺表
			<form id="inputForm"    method="post" enctype="multipart/form-data">
			<input type="hidden" name="procId" id="proctypeid" value="${ inforeport.TProctype.sm}"/>
				<ul id="tab" class="tab">
					<li>
				...
				<input name="id" value="${ inforeport.id}"hidden>
					<tr>
						<th>
							粮仓:
						</th>
					...
					<tr><th><span class="requiredField">*</span> 工艺名称：</th> <td><input type="text" name="proname" maxlength="60" style="width: 400px;" value="${ inforeport.proname}"></td></tr>
					<tr><th> 工艺类型：</th>
						<td colspan="3"><input id="proctypeSel" type="text" readonly style="width:120px;" value="${ inforeport.TProctype.proctype}"/>&nbsp;<a id="menuBtn" href="javascript:void(0);" onclick="showMenu(); return false;">选择</a>
					...
					<tr>
						...
						<td>
							<input class="easyui-datebox" name="startdate" value="${inforeport.startdate }">
						</td>
					</tr>
					<tr>
						<th>
						...
						<td>
							<input class="easyui-datebox" name="enddate" value="${inforeport.enddate }">
						</td>
					</tr>
					<tr><th> 信息来源：</th><td><input type="text" name="source" class="text" maxlength="100" value="${inforeport.source }"/></td></tr>
				</table>
				<!-- 工艺过程 -->
				<table class="input tabContent">
					<tr>
						<td>
							<textarea id="processeditor" name="process" style="width: 98%;" >${inforeport.process }</textarea>
						</td>
					</tr>
				</table>
				<!-- 备注 -->
				<table class="input tabContent">
					<tr>
						<td>
							<textarea id="noteeditor" name="note" style="width: 98%;">${inforeport.note}</textarea>
						</td>
					</tr>
