	...
	$inputForm.validate({
		rules: {
 		...
 		submitHandler: function() {
			...
			$.ajax({
				url : 'editDepotUserPass',//$("#inputForm").attr("action"),
...
<body class="easyui-layout">
		...
		<form id="inputForm"    method="post" enctype="multipart/form-data">
			<table class="input tabContent">
				<tr style="display:none"><th> 储粮区：</th> <td>${user.graindepot.area.gd.fullname}</td></tr>
				<tr style="display:none"><th><span class="requiredField">*</span> 粮库：</th> <td>${user.graindepot.lkmc}
				...
				<tr style="display:none"><th><span class="requiredField">*</span> 用户名：</th><td>
					<input type="text" name="username" class="text" readonly="readonly" value="${user.username}"/></td></tr>
				<tr style="display:none"><th> 真实姓名：</th><td><input type="text" name="realname" class="text" value="${user.realname}" /></td></tr>
				<tr>
					<th>原密码：</th> 
					<td>
				...
				<tr><th> 密码：</th><td><input type="password" id="pass" name="pass" class="text" /></td></tr>
				<tr>
					<th>确认密码：</th>
					<td>
				...
				<tr style="display:none"><th> 职称：</th><td><input type="text" name="title" class="text" value="${user.title}" /></td></tr>
				<tr style="display:none"><th> 手机：</th><td><input type="text" name="mobile" class="text" value="${user.mobile}" /></td></tr>
