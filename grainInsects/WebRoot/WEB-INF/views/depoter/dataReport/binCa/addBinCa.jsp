...
/* 			pass: {
 		...
 		submitHandler: function() {
			...
			$.ajax({
				url : 'addBinCa',//$("#inputForm").attr("action"),
	...
	<div class="container" >
		...
		<form id="inputForm"    method="post" enctype="multipart/form-data">
			...
			<table class="input tabContent">				
				...
				<tr>
					<th>年度</th><td>${annual}</td>
					<th> 填报日期：</th><td><input type="text" name="reportdate" class="easyui-datebox"/></td>
				</tr>
				<tr>
				...
				<tr>
					<th> 开始日期：</th><td><input type="text" name="startdate" class="easyui-datebox"/></td>
					<th> 结束日期：</th><td><input type="text" name="enddate" class="easyui-datebox"/></td>
				</tr>
			</table>
			<table class="input tabContent">
				<tr>
			...
			<table class="input tabContent"> <!-- 成本核算 -->
				<tr>
					<th> 制氮设备（元）：</th><td><input type="text" name="Nitrogendevice" class="text"/></td>
					<th> 气调智能控制系统（品牌）：</th><td><input type="text" name="controlsystem" class="text"/></td>
				</tr>
				<tr>
					<th>空气压缩机（元）：</th><td><input type="text" name="Aircompressor" class="text" /></td>
					<th>制氮机房（元）：</th><td><input type="text" name="Nitrogenroom" class="text" /></td>
				</tr>
				<tr>
					<th>空气呼吸器（元）：</th><td><input type="text" name="Respirator" class="text" /></td>
					<th>管道及施工费（元）：</th><td><input type="text" name="pipleandfee" class="text" /></td>
				</tr>
				<tr>
					<th>空气充气泵（元）：</th><td><input type="text" name="airpump" class="text" /></td>
					<th>电缆及施工费（元）：</th><td><input type="text" name="cableandfee" class="text" /></td>
				</tr>
				<tr>
					<th>低氧报警仪（元）：</th><td><input type="text" name="Hypoxiaalarm" class="text" /></td>
					<th>电缆、槽管、压条、薄膜及施工费（元）：</th><td><input type="text" name="auxiliaryandfee" class="text" /></td>
				</tr>
				<tr>
					<th>氧气浓度检测仪（元）：</th><td><input type="text" name="oxygendetectdevice" class="text" /></td>
					<th>电费（元）：</th><td><input type="text" name="electricityfee" class="text" /></td>
				</tr>
			</table>
			...
			<table class="input tabContent"> <!--气调储粮-->
				<tr>
					<th>充气时间（h）</th><td><input type="text" name="chargetime" class="text" /></td>
				</tr>
				<tr>
					<th>充气工艺:</th><td><input type="text" name="chargepro" class="text" /></td>
					<th>平均最高浓度(%)：</th><td><input type="text" name="maxconcentration" class="text" /></td>
				</tr>
				<tr>
					<th>目标浓度维持时间（h）</th><td><input type="text" name="keeplong" class="text" /></td>
					<th>充氮时平均粮温(°C)：</th><td><input type="text" name="avggraintemperature" class="text" /></td>
				</tr>
				<tr>
					<th>充氮时最高粮温(°C)</th><td><input type="text" name="highgraintemperature" class="text" /></td>
					<th>充氮时最低粮温(°C)：</th><td><input type="text" name="lowestgraintemperture" class="text" /></td>
				</tr>
			...
			<table class="input tabContent"><!-- 防治效果 -->
				<tr>
					<th>气调前虫口密度：</th><td><input type="text" name="densitybefca" class="text" /></td>
					<th>氮气平均浓度范围：</th><td><input type="text" name="varconcentration" class="text" /></td>
				</tr>
				<tr>
					<th>气调后虫口密度：</th><td><input type="text" name="densityafterca" class="text" /></td>
			...
			<table class="input tabContent"> <!-- 品质变化 -->
				<tr>
					<th>脂肪酸值(防治害虫前):</th><td><input type="text" name="fattyacidvaluebef" class="text" /></td>
					<th>脂肪酸值(气调防治害虫前):</th><td><input type="text" name="fattyacidvalueafter" class="text" /></td>
				</tr>	
				<tr>
