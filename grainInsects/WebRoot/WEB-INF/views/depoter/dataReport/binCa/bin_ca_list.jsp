...
/* 		$.ajax({
	...
	function editFun(index) {
		openBlank('editBinCaEntrance',{id:index});
	}
	...
	function addFun() {
		...
		openBlank('addBinCaEntrance',{lcbm:$("#grain-bin").val(),annual:$("#year").val()} );
	}
</script>
</head>
<body>
