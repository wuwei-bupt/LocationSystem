...
/* 			pass: {
 		...
 		submitHandler: function() {
			...
			$.ajax({
				url : 'addBinCleankill',//$("#inputForm").attr("action"),
	...
	<div class="container" >
		...
		<form id="inputForm"    method="post" enctype="multipart/form-data">
			...
			<table class="input tabContent">
				...
				<tr><th> 填报日期：</th><td><input type="text" name="reportdate" class="easyui-datebox"/></td></tr>
				...
				<tr><th> 药剂名称：</th><td><input type="text" name="drug"/></td><th>药剂厂家：</th><td><input type="text" name="drugfactory"/></td></tr>
				<tr><th> 施药方法及设施：</th><td colspan="3"><input style="width:75%;" type="text" name="deviceandway"/></td></tr>
			</table>
		    <!-- 粮仓情况 -->
			<table class="input tabContent">
