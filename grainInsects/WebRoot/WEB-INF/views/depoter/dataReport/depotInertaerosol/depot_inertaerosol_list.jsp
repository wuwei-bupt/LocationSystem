...
// 			},
	...
	function editFun(index) {
		...
		openBlank('editDepotInertaerosolEntrance',{id:index});
		//debug
		console.log("2222222");
		console.log(index);
	}
	...
	function addFun() {
		openBlank('addDepotInertaerosolEntrance',{ } );
	}
</script>
</head>
<body class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title="数据上报 > 惰性气溶液总表 " style="overflow: hidden;">
