...
<script type="text/javascript">
	...
	function editFun(index) {
		openBlank('editBinInertaerosolEntrance',{lcbm:$("#grain-bin").val(),annual:$("#year").val(),id:index});	
	}
	...
	function addFun() {
		...
		if($("#grain-bin").val()==0){
			parent.$.messager.alert('提示','请选择粮仓!','info'); //easyui中的控件messager
			goback();
		} else {
			openBlank('addBinInertaerosolEntrance',{lcbm:$("#grain-bin").val(),annual:$("#year").val()} );
		}
...
<body>
	...
	<div data-options="region:'center',border:false" title="数据上报 > 惰性气溶液分仓表" style="overflow: hidden;">
