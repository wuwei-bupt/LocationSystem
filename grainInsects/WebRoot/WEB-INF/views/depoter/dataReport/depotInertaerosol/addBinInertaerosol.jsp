...
/* 			pass: {
 		...
 		submitHandler: function() {
			...
			$.ajax({
				url : 'addBinInertaerosol',//$("#inputForm").attr("action"),
	...
	<div class="container" >
		...
		<form id="inputForm"    method="post" enctype="multipart/form-data">
			...
			<table class="input tabContent">
				...
				<tr><th> 施药方法及设施：</th><td><input type="text" name="deviceandbrand" class="text"/></td><th> 药剂厂家：</th><td><input type="text" name="factory" class="text"/></td></tr>
			</table>
			...
			<table class="input tabContent"> <!-- 成本核算 -->
				<tr><th> 施粉器械（元）：</th><td><input type="text" name="device" class="text" /></td><th> 惰性粉药剂（品牌）：</th><td><input type="text" name="brand" class="text"/></td></tr>
				<tr><th> 惰性粉用量（kg）：</th><td><input type="text" name="dosage" class="text" /></td><th> 惰性粉费用（元）：</th><td><input type="text" name="drugfee" class="text" /></td></tr>
				<tr><th> 防尘和过滤口罩等防护用品（元）：</th><td><input type="text" name="protective" class="text" /></td><th> 使用补助（元）：</th><td><input type="text" name="subsidy" class="text" /></td></tr>
				<tr><th> 施粉时长（小时）：</th><td><input type="text" name="keeplong" class="text" /></td><th> 劳务费用（元）：</th><td><input type="text" name="laborfee" class="text" /></td></tr>
				<tr><th> 其他（元）：</th><td><input type="text" name="otherfee" class="text" /></td></tr>
			...
			<table class="input tabContent"> <!-- 防治效果 -->
				...
				<tr><th> 施药后虫口密度：</th><td><input type="text" name="densityafter" class="text" /></td><th> 主要虫种：</th><td><input type="text" name="kindaf" class="text" /></td></tr>
