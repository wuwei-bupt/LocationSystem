...
/* 			pass: {
 		...
 		submitHandler: function() {
			...
			$.ajax({
				url : 'addBinPhosphinefumigation',//$("#inputForm").attr("action"),
	...
	<div class="container" >
		...
		<form id="inputForm"    method="post" enctype="multipart/form-data">
			...
			<table class="input tabContent"><!-- 基本情况 -->			
				...
				<tr>
					<th> 熏蒸开始日期：</th><td><input type="text" name="startdate" class="easyui-datebox" /></td>
					<th> 熏蒸结束日期：</th><td><input type="text" name="enddate"  class="easyui-datebox" /></td>
				</tr>
				<tr>
			...
			<table class="input tabContent"> <!-- 成本核算 -->
				...
				<tr>
					...
					<th>其他（元）：</th><td><input type="text" name="elsefee" class="text"/></td>
				</tr>
			</table>
			...
			<table class="input tabContent"> <!-- 熏蒸杀虫 -->
				<tr>
					<th>累计熏蒸时间（天）:</th><td><input type="text" name="totaldays" class="text" /></td>
				...
				<tr>
					...
					<td>
						...
						其他<input type="text" name="othergiveway" class="text"/>
					</td>
				</tr>
				<tr>
			...
			<table class="input tabContent"><!-- 防治效果 -->
				...
				<tr>
					...
					<th>是否放置虫笼（虫源）及虫种：</th><td><input type="text" name="densityafterca" class="text" /></td>
				</tr>
				<tr>
