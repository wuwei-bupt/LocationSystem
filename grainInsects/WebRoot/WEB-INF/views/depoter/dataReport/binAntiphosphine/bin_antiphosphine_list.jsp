...
/* 		$.ajax({
	...
	function editFun(index) {
		openBlank('editBinAntiphosphineEntrance',{id:index});
	}
	...
	function addFun() {
		...
		openBlank('addBinAntiphosphineEntrance',{lcbm:$("#grain-bin").val(),annual:$("#year").val()} );
	}
</script>
</head>
<body>
	...
	<div data-options="region:'center',border:false" title="数据上报  > 磷化氢抗药分仓表" style="overflow: hidden;">
