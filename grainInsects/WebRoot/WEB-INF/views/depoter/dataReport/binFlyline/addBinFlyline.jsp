...
/* 			pass: {
 		...
 		submitHandler: function() {
			...
			$.ajax({
				url : 'addBinFlyline',//$("#inputForm").attr("action"),
	...
	<div class="container">
		...
		<form id="inputForm" method="post" enctype="multipart/form-data">
			...
			<table class="input tabContent">
				<!-- 基本情况 -->
				<tr>
					<th>粮库名称：</th>	<td>${lkmc}</td>
					<th>粮库编号：</th><td>${lkbm}</td>
				</tr>
				<tr>
					<th><span class="requiredField">*</span> 年份：</th><td>${annual}</td>
				...
				<tr>
					<th>药剂名称：</th>
					<td><input type="text" name="totaluse" class="text" /></td>
					<th>药剂厂家：</th>
					<td><input type="text" name="proportion" class="text" /></td>
				</tr>
				<tr>
					<th>施药设施及方法：</th>
					<td colspan="3"><input type="text" name="deviceandway"
						class="text" style="width: 80%;" /></td>
				</tr>
			</table>
			...
			<table class="input tabContent">
				...
				<tr>
					<th>施药器械（元）：</th>
					<td><input type="text" name="device" class="text" /></td>
					<th>防虫线杀虫剂药剂（品牌）：</th>
					<td><input type="text" name="brand" class="text" /></td>
				</tr>
				<tr>
					<th>空仓杀虫剂用量（kg）：</th>
					<td><input type="text" name="Dosage" class="text" /></td>
					<th>防虫线杀虫剂费用（元）：</th>
					<td><input type="text" name="drugfee" class="text" /></td>
				</tr>
				<tr>
					<th>防尘和过滤口罩等防护用品（元）：</th>
					<td><input type="text" name="protective" class="text" /></td>
					<th>药剂使用补助（元）：</th>
					<td><input type="text" name="subsidy" class="text" /></td>
				</tr>
				<tr>
					<th>施药时长（小时）：</th>
					<td><input type="text" name="keeplong" class="text" /></td>
					<th>劳务费用（元）：</th>
					<td><input type="text" name="laborfee" class="text" /></td>
				</tr>
				<tr>
					<th>其他（元）：</th>
...
<!-- 							style="width: 300px; height: 50px;" class="text"></textarea> -->
<!-- 				</tr> -->
				<tr>
					<th>粮面处理（g/m2）：</th>
...
<!-- 				</tr> -->
			...
			<table class="input tabContent">
				...
				<tr>
					<th>施药前虫口密度：</th>
					<td><input type="text" name="densitybef" class="text" /></td>
					<th>主要虫种：</th>
					<td><input type="text" name="kindbef" class="text" /></td>
				</tr>
				<tr>
					<th>施药后虫口密度（头/m2） ：</th>
					<td colspan="3"><input type="text" name="densityafter" class="text" /></td>
				</tr>
				<tr>
					<th>无虫期间隔（天）：</th>
			...
			<table class="input">
				<tr>
					<th>&nbsp;</th>
					<td>
						<!--  <input type="submit" class="button" value="save" /> --> <a
						href="javascript:void(0)" class="easyui-linkbutton" plain="false"
						onclick="doAdd()" iconCls="icon-save">保存</a> <a
						href="javascript:void(0)" class="easyui-linkbutton" plain="false"
						onclick="goback()" iconCls="icon-back">返回</a>
					</td>
				</tr>
			</table>
		</form>
