...
<script type="text/javascript">
	...
	function editFun(index) {
		openBlank('editDepotProtectedEntrance',{id:index});
	}

	function addFun() {
		openBlank('addDepotProtectedEntrance',{ } );
	}
</script>
</head>
<body class="easyui-layout" data-options="fit:true,border:false">

	<div data-options="region:'center',border:false" title="数据上报 > 防护剂总表" style="overflow: hidden;">
