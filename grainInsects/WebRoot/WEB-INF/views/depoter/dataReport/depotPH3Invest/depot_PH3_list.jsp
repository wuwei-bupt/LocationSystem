...
<script type="text/javascript">
	...
	function editFun(index) {
		openBlank('editDepotPhosphinefumigationEntrance',{id:index});
	}

	function addFun() {
		openBlank('addDepotPhosphinefumigationEntrance',{ } );
	}
</script>
</head>
<body class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title="数据上报 > 磷化氢熏蒸总表 " style="overflow: hidden;">
