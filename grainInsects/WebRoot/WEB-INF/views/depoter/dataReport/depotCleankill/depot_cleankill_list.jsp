...
<script type="text/javascript">
		...
		if (id!=null){
			...
			parent.$.messager.confirm('询问', '您是否要删除当前上报记录 ？', function(b) {
				if (b) {
					...
					$.post('deleteDeportCleankillReportRec', {
						id : id
					}, function(result) {
	...
	function editFun(index) {
		openBlank('editDepotCleankillEntrance',{id:index});
	}

	function addFun() {
		openBlank('addDepotCleankillEntrance',{ } );
	}
</script>
</head>
<body class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title="数据上报  > 空仓杀虫总表 " style="overflow: hidden;">
