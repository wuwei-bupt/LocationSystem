...
<script type="text/javascript">
	...
	function editFun(index) {
		openBlank('editDepotInvestEntrance',{sm:index});
	}

	function addFun() {
		openBlank('addDepotInvestEntrance',{} );
	}
</script>
</head>
<body class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title="数据上报 > 害虫调查总表" style="overflow: hidden;">
