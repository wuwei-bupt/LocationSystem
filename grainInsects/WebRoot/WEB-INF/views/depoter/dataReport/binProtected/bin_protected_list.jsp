...
/* 		$.ajax({
	...
	function editFun(index) {
		openBlank('editBinProtectedEntrance',{id:index});
	}
	...
	function addFun() {
		...
		openBlank('addBinProtectedEntrance',{lcbm:$("#grain-bin").val(),annual:$("#year").val()} );
	}
</script>
</head>
<body class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title="数据上报 > 防护剂分仓表" style="overflow: hidden;">
