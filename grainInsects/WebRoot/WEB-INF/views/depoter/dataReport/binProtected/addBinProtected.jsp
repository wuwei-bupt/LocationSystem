...
/* 			pass: {
 		...
 		submitHandler: function() {
			...
			$.ajax({
				url : 'addBinProtected',//$("#inputForm").attr("action"),
	...
	<div class="container" >
		...
		<form id="inputForm"    method="post" enctype="multipart/form-data">
			...
			<table class="input tabContent"><!-- 基本情况 -->			
				...
				<tr>
					<th>药剂名称</th><td><input type="text" name="" class="text" /></td>
					<th>药剂厂家</th><td><input type="text" name="factory" class="text" /></td>
				</tr>
				<tr>
					<th> 施药方法及设施：</th> <td colspan="3"><input type="text" name="" style="width:90%;" class="text"/></td>
				</tr>
			</table>
			<!-- 粮仓情况 -->
			...
			<table class="input tabContent"> <!-- 成本核算 -->
				...
				<tr>
					<th>施药时长（小时）：</th><td><input type="text" name="keeplong" class="text" /></td>
