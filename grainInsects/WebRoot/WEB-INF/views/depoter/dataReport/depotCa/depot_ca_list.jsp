...
<script type="text/javascript">
	...
	function editFun(index) {
		openBlank('editDepotCaEntrance',{id:index});
	}

	function addFun() {
		openBlank('addDepotCaEntrance',{ } );
	}
</script>
</head>
<body class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title="数据上报 > 氮气气调总表 " style="overflow: hidden;">
