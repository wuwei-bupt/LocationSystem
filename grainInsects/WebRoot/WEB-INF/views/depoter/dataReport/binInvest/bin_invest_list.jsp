		...
		dataGrid = $('#dataGrid').datagrid({
			...
			columns : [ [ {
			...
			},
			 {
				...
				field : 'tgrainbin.typebin',
				title : '粮仓类型',
				width : 40,
				align : "center"
			},{
				field : 'tgrainbin.capacity',
				title : '储粮规模',
				width : 40,
				align : "center"
			},{
...
/* 		$.ajax({
	...
	function editFun(index) {
		openBlank('editBinInvestEntrance',{sm:index});
	}
	...
	function addFun() {
		...
		openBlank('addBinInvestEntrance',{lcbm:$("#grain-bin").val(),annual:$("#year").val()} );
	}
</script>
</head>
<body>
	...
	<div data-options="region:'center',border:false" title="数据上报 > 害虫分仓调查表" style="overflow: hidden;">
