...
<script type="text/javascript">
	...
	function editFun(index) {
		openBlank('editDepotAntiphosphineEntrance',{id:index});
	}

	function addFun() {
		openBlank('addDepotAntiphosphineEntrance',{ } );
	}
</script>
</head>
<body class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title="数据上报  > 磷化氢抗药总表 " style="overflow: hidden;">
