	...
	$inputForm.validate({
		rules: {
 		...
 		submitHandler: function() {
			...
			$.ajax({
				url : 'addIdea',//$("#inputForm").attr("action"),
...
<body class="easyui-layout">
	<div data-options="region:'center',border:false" title="监测预报 > 专家意见 > 新增" style="">
		<div class="container" >
				...
				<table class="input tabContent"><!-- 基本情况 -->			
					...
					<tr>
						...
						<td>
							...
							<input name="lkbms[]" class="easyui-combobox" data-options="
								multiple:true,
								valueField: 'value',
								textField: 'text',
								data: [
					...
					<tr>
						<th><span class="requiredField">*</span>主题：</th><td><input type="text" name="topic" class="text" required/></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<textarea id="editor" name="opinion" class="editor" style="width: 98%;" required></textarea>
						</td>
					</tr>	
				</table>
				<table class="input">
