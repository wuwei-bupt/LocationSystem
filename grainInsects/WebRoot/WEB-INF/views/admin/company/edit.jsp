...
/* 			pass: {
 		...
 		submitHandler: function() {
			...
			$.ajax({
				url : 'editCompany',//$("#inputForm").attr("action"),
	...
	<div class="container" >
		...
		<form id="inputForm"    method="post" enctype="multipart/form-data">
			...
			<table class="input tabContent">
				...
				<tr><th> 单位编码：</th><td colspan="3"><input type="text" name="coding" class="text" value="${company.coding}" maxlength='10'></td></tr>
				<tr><th><span class="requiredField">*</span> 单位名称：</th><td colspan="3"><input type="text" name="company" class="text" value="${company.company}" maxlength='100'></td></tr>
			</table>
