			...
			<form id="inputForm"  method="post">
				<table class="input tabContent">
					...
					<!-- <tr>
						...
						<td>
							<input type="text" name="hasaudit" class="easyui-combobox" data-options="valueField:'id',textField:'value',data: [ {id: '0',value: '否'	,selected:true},{	id: '1',	value: '是'	} ]"/>
						</td>
					</tr> -->
					<tr>
						<th>
