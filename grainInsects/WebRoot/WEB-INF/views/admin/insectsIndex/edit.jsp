...
// 	var indexSpecification = 0;
	...
	var options = {
		...
		KindEditor.ready(function(K) {
			...
			editorList[1]=K.create("#auditadviceeditor",optionsReadOnly);
		});
		}
	...
	<div class="container" >
		...
		<form id="inputForm"    method="post" enctype="multipart/form-data">
			...
			<table class="input tabContent" id="expertAuditTable" style="display:none;">
				...
				<tr><th> 审核意见：</th>
					<td>
						<textarea id="auditadviceeditor" name="auditadvice" style="width: 98%;">${insectsIndex.auditadvice}</textarea>
					</td>
				</tr>
