...
<title>${message("admin.article.list")} - Powered By Szy++</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index">${message("admin.path.index")}</a> &raquo; ${message("admin.article.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
