...
<body >
	<div class="easyui-layout" data-options="fit:true,border:false">
		<div data-options="region:'center',border:false" title="知识库  > 防治技术  > 新增 ">
		<br>&nbsp;&nbsp;&nbsp;&raquo;防治工艺表
		...
		<input type="hidden" name="procId" id="proctypeid"/>
			...
			<table class="input tabContent">
				<tr><th><span class="requiredField">*</span> 工艺编码：</th> <td><input type="text" name="sm" maxlength="10"></td></tr>
				...
				<tr><th><span class="requiredField">*</span> 关键词：</th><td><input type="text" name="keywords" class="text" maxlength="200" style="width: 400px;"/></td></tr>
				<tr><th> 材料：</th><td><input type="text" name="material" class="text" maxlength="200" style="width: 400px;"/></td></tr>
				<tr><th> 处理方式：</th><td><input type="text" class="text" name="procway" maxlength="200" style="width: 400px;"/></td></tr>
				<tr><th><span class="requiredField">*</span> 区域：</th><td><input type="text" name="area" class="text" maxlength="200" style="width: 400px;"/></td></tr>
				<tr><th><span class="requiredField">*</span> 季节：</th><td><input type="text" name="seasion" class="text" maxlength="60" style="width: 400px;"/></td></tr>
				<tr><th> 资料来源：</th><td><input type="text" name="source" class="text" maxlength="100"/></td></tr>
			</table>
			<!-- 工艺过程 -->
			<table class="input tabContent">
				<tr>
