...
<body>
	<div class="path">
		<a href="${base}/admin/common/index">${message("admin.path.index")}</a> &raquo; ${message("admin.area.list")}
	</div>
	<div class="bar">
		...
		[#if !areas?has_content]
			<tr>
				<td colspan="5" style="text-align: center; color: red;">
					${message("admin.area.emptyChildren")} <a href="add[#if parent??]?parentId=${parent.id}[/#if]" style="color: gray">${message("admin.common.add")}</a>
				</td>
			</tr>
		[/#if]
	</table>
