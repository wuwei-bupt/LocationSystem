...
<body>
	<div class="path">
		<a href="${base}/admin/common/index">${message("admin.path.index")}</a> &raquo; ${message("admin.area.edit")}
	</div>
				...
				<td>
					<select name="grainDirectionid" >
						[#list graindirection as graindirection]
							<option value="${graindirection.id}" [#if graindirection == area.gd] selected="selected"[/#if]>
