...
<title>${message("admin.navigation.add")} - Powered By Szy++</title>
			...
			<tr>
				...
				<td>
					<select id="systemUrl">
						...
						<option value="${base}/catalogIndex.jhtml">${message("admin.navigation.catalogIndex")}</option>
						...
						[#list catalogIndexTree as catalog]
							<option value="${base}${catalog.path}">
								[#if catalog.grade != 0]
