			...
			columns : [ [ {
			...
			}, 
			 {
				...
				formatter : function(value, row, index) {
					var str = '';
						str += $.formatString('<img onclick="editFun(\'{0}\');" src="{1}" title="关联粮仓"/>',row.username, '${pageContext.request.contextPath}/resources/easyUI/themes/extjs_icons/pencil.png');
					str += '&nbsp;';
...
/* 		window.open("", 'editDepotUser', 
		"height=450,width=500,top=100,left=400,toolbar=no, location=no, directories=no, status=no, menubar=no,copyhistory=no,channelmode=yes"); */
		openBlank('editDepotUserEntrance',{username:index}/* , 'editDepotUser' */ );
	}

	function addFun() {
/* 		window.open("addDepotUserEntrance", 'addDepotUser', 
		"height=500,width=500,top=100,left=400,toolbar=no, location=no, directories=no, status=no, menubar=no,copyhistory=no,channelmode=yes"); */
...
<body class="easyui-layout" data-options="fit:true,border:false">
	<div region="north" title="过滤条件" style="height:55px ;overflow:hidden;">
		<span>用户名:</span>
