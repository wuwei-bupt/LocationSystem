...
<html>
	...
	<body>
		<div class="path">路径>>编辑虫调用户信息</div>
		<div class="container" >
			<form id="inputForm"  method="post" enctype="multipart/form-data">
				<%-- <input type="hidden" name="recordId" value="${investor. }"/> --%>
				<table class="input tabContent">
					<tr>
						<th><span class="requiredField">*</span>用户名：</th>
						<td><input name="username" class="text" type="text" readonly="readonly" value="${investor.username }"/></td>
					</tr>
					<tr>
						<th>真实姓名：</th>
						<td><input name="realname" class="text" type="text" value="${investor.realname }"/></td>
					</tr>
					<tr>
						<th>密码：</th>
					...
					<tr>
						...
						<td>
							<input name="point" class="text" type="text" value="${investor.point }"/>
						</td>
					</tr>
					<tr>
						<th>职位：</th>
						<td><input name="title" class="text" type="text" value="${investor.title }"/></td>
					</tr>
					<tr>
						<th>单位：</th>
						<td>
							<input name="company" class="text" type="text" value="${investor.company }"/>
						</td>
					</tr>
					<tr>
						<th>手机：</th>
						<td><input name="moblie" class="text" type="text" value="${investor.moblie }"/></td>
					</tr>
					<tr>
						<th>
						...
						<td>
							<select name="hasaudit" >
								<option value=0 <c:if test="${!investor.hasaudit}"> selected="true" </c:if> >否</option>
								<option value=1 <c:if test="${investor.hasaudit}"> selected="true" </c:if> >是</option>
							</select>
						</td>
					</tr>
