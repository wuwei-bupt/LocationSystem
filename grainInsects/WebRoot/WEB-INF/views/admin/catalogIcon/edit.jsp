...
/* 			pass: {
 		...
 		submitHandler: function() {
			...
			$.ajax({
				url : 'editCatalogIcon',//$("#inputForm").attr("action"),
...
<body >
	<div class="easyui-layout" data-options="fit:true,border:false">
		<div data-options="region:'center',border:false" title="基础资料  > 图标管理  > 编辑 ">
		<form id="inputForm"    method="post" enctype="multipart/form-data">
		<input type="hidden" name="id" id="catalogIconId" value="${catalogIconId}"/>
			<ul id="tab" class="tab">
				<li>
			...
			<table class="input tabContent">
				<tr><th><span class="requiredField">*</span> 害虫中文名：</th> <td><input type="text" name="name" value="${catalogIcon.name}" maxlength="60" style="width: 400px;"></td></tr>
				<tr><th><span class="requiredField">*</span> 害虫图标文件名：</th> <td><input type="text" name="cssname" value="${catalogIcon.cssname}" maxlength="50" style="width: 400px;"></td></tr>
			</table>
			<table class="input">
				<tr><th>&nbsp;</th>
				<td >
