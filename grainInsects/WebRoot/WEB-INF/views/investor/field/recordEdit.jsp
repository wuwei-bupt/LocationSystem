		...
		<form id="inputForm"  method="post" enctype="multipart/form-data">
			...
			<table class="input tabContent">
				...
				<tr>
					<th>采集日期:</th>
					<td>
						<input type="text" name="collectdate" class="text Wdate" value="${fieldCollectRecord.collectdate }" onfocus="WdatePicker({dateFmt: 'yyyy-MM-dd'});" />
					</td>
				</tr>
				<tr>
					<th>温度：</th>
				...
				<tr>
					<th>GPS：</th>
					<td>
						GPS(E)&nbsp;<input name="longtitude" class="myinput" type="text" style="width:150px" value="${fieldCollectRecord.longtitude }"/>&nbsp;、
						GPS(N)&nbsp;<input name="latitude" class="myinput" type="text" style="width:150px" value="${fieldCollectRecord.latitude }"/>&nbsp;
					</td>
				</tr>
			</table>
			<!-- 虫害信息 -->
