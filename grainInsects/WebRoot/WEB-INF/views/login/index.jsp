...
<title>${message("member.login.title")}- Powered By com.grain</title>
<meta name="author" content="stored grain insects Team" />
<meta name="copyright" content="stored grain insects" />
...
<script type="text/javascript" src="${base}/resources/member/js/jsbn.js"></script>
<script type="text/javascript" src="${base}/resources/member/js/prng4.js"></script>
<script type="text/javascript" src="${base}/resources/member/js/rng.js"></script>
<script type="text/javascript" src="${base}/resources/member/js/rsa.js"></script>
<script type="text/javascript" src="${base}/resources/member/js/base64.js"></script>
					...
					<form id="loginForm" action="${base}/login/submit.jhtml" method="post">
						<table>
							<tr>
								<th>
									[#if setting.isEmailLogin]
										${message("member.login.usernameOrEmail")}:
									[#else]
							...
							[#if setting.captchaTypes?? && setting.captchaTypes?seq_contains("memberLogin")]
								<tr>
									<th>
										${message("member.captcha.name")}:
									</th>
									<td>
										<span class="fieldSet">
											<input type="text" id="captcha" name="captcha" class="text captcha" maxlength="4" autocomplete="off" /><img id="captchaImage" class="captchaImage" src="${base}/common/captcha.jhtml?captchaId=${captchaId}" title="${message("member.captcha.imageTitle")}" />
										</span>
									</td>
								</tr>
							[/#if]
							<tr>
								...
								<td>
									...
									<label>
										&nbsp;&nbsp;<a href="${base}/password/find.jhtml">${message("member.login.findPassword")}</a>
									</label>
								</td>
							</tr>
							<tr>
								...
								<td>
									<dl>
										...
										<dd>
											...
											<a href="${base}/register.jhtml">${message("member.login.register")}</a>
										</dd>
									</dl>
								</td>
							</tr>
