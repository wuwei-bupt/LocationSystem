...
@Service("tDigitalPicServiceImpl")
public class TDigitalPicServiceImpl extends BaseServiceImpl<TDigitalPic,Long>
implements TDigitalPicService,ServletContextAware{
	/** 目标扩展名 */
	...
	public void build(TDigitalPic productImage) {
