...
/**
 * Service - grian bin type 图片
 * 
 */
@Service("farmerCollectionPicServiceImpl")
public class FarmerCollectionPicServiceImpl implements FarmerCollectionPicService,ServletContextAware{
	...
	@Override
	public String build(TInsectsCollectPic pic) {
