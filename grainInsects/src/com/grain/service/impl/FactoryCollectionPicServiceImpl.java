 ...
 * 
 */
@Service("factoryCollectionPicServiceImpl")
public class FactoryCollectionPicServiceImpl implements FactoryCollectionPicService,ServletContextAware{
	...
	@Override
	public String build(TFactoryPic pic) {
