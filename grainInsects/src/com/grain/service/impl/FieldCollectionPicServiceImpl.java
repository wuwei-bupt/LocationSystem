 ...
 * 
 */
@Service("fieldCollectionPicServiceImpl")
public class FieldCollectionPicServiceImpl implements FieldCollectionPicService, ServletContextAware{
	...
	@Override
	public String build(TFieldPic pic) {
