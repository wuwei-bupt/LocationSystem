...
import com.grain.Setting.AccountLockType;
import com.grain.Setting.CaptchaType;
import com.grain.Setting.ConsultationAuthority;
import com.grain.Setting.ReviewAuthority;
import com.grain.Setting.RoundType;
import com.grain.Setting.StockAllocationTime;
import com.grain.Setting.WatermarkPosition;
import com.grain.service.CacheService;
import com.grain.service.FileService;
import com.grain.service.MailService;
...
public class SettingController extends BaseController {
	...
	public String update(Setting setting, MultipartFile watermarkImageFile, RedirectAttributes redirectAttributes) {
		...
		try {
			org.springframework.core.io.Resource resource = new ClassPathResource(CommonAttributes.GRAIN_PROPERTIES_PATH);
